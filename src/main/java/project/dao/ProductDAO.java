...
public class ProductDAO {
	...
	@Transactional
	public void updateHospital(Hospital p, int id) {
...
//			System.out.println("In update" );
	...
	@Transactional
	public void updateComplex(Complex p, int id) {
		ownerDetails o = hibernateTemplate.get(ownerDetails.class, id);
		p.setOwner(o);
		this.hibernateTemplate.update(p);
	}
	...
	@Transactional
	public void updateVilla(Villa p, int id) {
		ownerDetails o = hibernateTemplate.get(ownerDetails.class, id);
		p.setOwner(o);
		this.hibernateTemplate.update(p);
	}
	...
	@Transactional
	public void updateOffice(Office p, int id) {
		ownerDetails o = hibernateTemplate.get(ownerDetails.class, id);
		p.setOwner(o);
		this.hibernateTemplate.update(p);
	}
	...
	@Transactional
	public void updateResidentialBuilding(ResidentialBuilding p, int id) {
		ownerDetails o = hibernateTemplate.get(ownerDetails.class, id);
		p.setOwner(o);
		this.hibernateTemplate.update(p);
	}
