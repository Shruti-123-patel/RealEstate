...
//	Different
	...
	public Complex(int owner_id, int price, int pincode, String city_name, String address_line_1, String address_line_2,
			String area, byte[] image_1, byte[] image_2, byte[] image_3, int no_of_shops) {
		super();
