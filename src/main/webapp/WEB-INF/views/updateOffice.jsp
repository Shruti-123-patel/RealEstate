...
<body>
	...
	<div class="full-screen-container">
		<div class="login-container">
			...
			<form:form action="updateOffice" method="POST" modelAttribute="obj" enctype="multipart/form-data">
				...
				<div class="input-group">
					<form:input value="${obj.ConferenceRooms }" path="ConferenceRooms" />
				</div>
				<div class="input-group">
					<form:input value="${obj.WaitingRooms }" path="WaitingRooms" />
				</div>
