...
<%@page import="project.dao.ComplexFetchDao"%>
<%@page import="project.beans.Complex"%>
...
<html>
    ...
    <body>
        ...
        <div class="house" style="margin-top: 25px;">
            <center>
                <h1 style="border-bottom: 2px dotted black;">-: Best Shopping Complex in the Country :-
                </h1>
            </center>
        </div>
                ...
                <div class="description">
                    ...
                    <div>    
                        <form action="Purchase" method="post">
                            ...
                            <input type="hidden" value="3" name="ProductKeyId">
