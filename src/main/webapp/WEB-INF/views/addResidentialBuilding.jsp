...
<body>
	...
	<div class="full-screen-container">
		<div class="login-container">
			...
			<form:form action="addResidentialBuilding" method="POST" modelAttribute="obj" enctype="multipart/form-data">
				<div>
					<h1>Add Residential Building</h1>
				</div>
				<div class="input-group">
					<form:input path="Name" placeholder="Enter Name"/>
				</div>
				<div class="input-group">
					<form:input path="Bedrooms" placeholder="Enter BedRooms"/>
				</div>
				<div class="input-group">
