...
<body>
	...
	<div class="full-screen-container">
		<div class="login-container">
			...
			<form:form action="addHospital" method="POST" modelAttribute="obj" enctype="multipart/form-data">
				<div>
					<h1>Add Hospital</h1>
				</div>
				...
				<div class="input-group">
					<form:input path="GeneralRooms" placeholder="Enter Number of General Rooms"/>
				</div>
				<div class="input-group">
					<form:input path="OT" placeholder="Enter Number of OT"/>
				</div>
				<div class="input-group">
					<form:input path="ICU" placeholder="Enter Number of ICU"/>
				</div>
				<div class="input-group">
					<form:input path="chambers" placeholder="Enter Number of Chambers"/>
				</div>
				<div class="input-group">
