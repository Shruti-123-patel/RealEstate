										...
										<div class="slider-text-inner">
											<div class="desc">
												...
												<p>Far far away, behind the word mountains, far from the
													...
													texts.</p>
												<p class="details">
													<span>2000 ft sq</span> <span>4 Bedrooms</span> <span>3
														Bathrooms</span> <span>2 Garage</span>
												</p>
												<p>
						...
						<div class="row">
							<div class="col-xxs-12 col-xs-12">
								<div class="input-field">
									<label for="from">Keyword:</label> <input type="text"
							...
							<div class="col-xxs-12 col-xs-12">
								<section>
									<label for="class">Property Type:</label> <select
										class="cs-select cs-skin-border input-half">
										<option value="" disabled selected>Any</option>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 animate-box">
							...
							<div class="feature-left">
								<span class="icon"> <i class="icon-map"></i>
								</span>
						...
						<div class="col-md-4 animate-box">
							<div class="feature-left">
								<span class="icon"> <i class="icon-browser"></i>
								</span>
								<div class="feature-copy">
									<h3>Mortgage</h3>
									<p>Facilis ipsum reprehenderit nemo molestias. Aut cum
					...
					<div class="row">
						<div class="col-md-4 animate-box">
							...
							<div class="feature-left">
								<span class="icon"> <i class="icon-piechart"></i>
								</span>
								<div class="feature-copy">
									<h3>Business Home</h3>
									<p>Facilis ipsum reprehenderit nemo molestias. Aut cum
							...
							<div class="property">
								...
								<div class="property-details">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing
										elit. Velit est facilis maiores.</p>
									<span class="address"><i class="icon-map"></i>Thomas
										Street, St. Louis, MO 8990, USA</span>
								</div>
							</div>
						</div>
						<div class="col-md-4 animate-box">
						...
						<div class="col-sm-3 text-center animate-box"
							...
							<div class="fh5co-staff">
								...
								<p>Quos quia provident consequuntur culpa facere ratione
									maxime commodi voluptates id repellat</p>
