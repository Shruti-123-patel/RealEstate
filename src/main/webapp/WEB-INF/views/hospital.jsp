...
<%@page import="project.dao.HospitalFetchDao"%>
<%@page import="project.beans.Hospital"%>
...
<body>
	...
	<div class="house" style="margin-top: 25px;">
		<center>
			<h1 style="border-bottom: 2px dotted black;">-: Hospitals for
				vital facility :-</h1>
		</center>
	</div>
	<%-- <% HospitalFetchDao dao = new HospitalFetchDao(FactoryProvider.getFactory());
		...
		<div class="gallary" style="margin-bottom: 50px">
			<div class="section">
				...
				<div class="description">
					<p>
						Owner Id : <span> ${rb.getOwner().getId()} </span>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Owner Name
						: <span> ${rb.getOwner().getName()} </span>
					</p>
					<br>
					<p>
						Owner Phone Number : <span> ${rb.getOwner().getPhone_no()}
						</span>
					</p>
					<br>
					<p>
						Number Of ICU Rooms : <span> ${rb.getICU()} </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Number
						Of Genral Room : <span> ${rb.getGeneralRooms() } </span>
					</p>
					<br>
					<p>
						City : <span style="margin-right: 280px;">${rb.getName()}</span>Price
						: <span>${rb.getPrice()}</span>
					</p>
					<br>
					<p>
						Description :- <span> ${rb.getDescription()} </span>
					</p>
					<br> <br>
					<div>
						<form action="Purchase" method="post">
							<input type="hidden" value="${rb.getId()}" name="HouseId">
							<input type="hidden" value="1" name="ProductKeyId"> <input
								type="submit" value=" Buy Now" class="btn2">
						</form>
					</div>
				</div>
			</div>
	...
	<footer class="footer-distributed">
		...
		<div class="footer-center">
			<div>
				...
				<p>
					<span>309 - Stark Tower, Madhaton, Center Tower</span> Nadiad, Navi
					Mumbai - 400710
				</p>
			</div>
			...
			<div>
				...
				<p>
					<a href="mailto:support@eduonix.com">support@ironman.com</a>
				</p>
			</div>
		</div>
		<div class="footer-right">
			<p class="footer-company-about">
				<span>About the company</span> We offer wide and the exotic
				collection of the real estate buildings and do global Transcations
				too
			</p>
