...
<body>
	...
	<div class="full-screen-container">
		<div class="login-container">
			...
			<form:form action="addOffice" method="POST" modelAttribute="obj" enctype="multipart/form-data">
				<div>
					<h1>Add Office</h1>
				</div>
				...
				<div class="input-group">
					<form:input path="ConferenceRooms" value="" data-value="" placeholder="Enter Number of Conference"/>
				</div>
				<div class="input-group">
					<form:input path="WaitingRooms" placeholder="Enter Number of WaitingRooms"/>
				</div>
				<div class="input-group">
