...
<body>
	...
	<div class="house" style="margin-top: 25px;">
		<center>
			<h1 style="border-bottom: 2px dotted black;">-: Villas that
				gives you the feelling like Mansion :-</h1>
		</center>
	</div>
	...
	<c:forEach var="rb" items="${obj}">
		...
		<div class="gallary" style="margin-bottom: 50px">
			<div class="section">
				<div class="img">
					<img src="images/house/" alt="" srcset="">
				</div>
				<div class="description">
					...
					<br>
					<p>
						Number Of Bedrooms : <span> ${rb.getBedrooms()} </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Number
						Of Floors : <span> ${rb.getFloors()} </span>
					</p>
					<br>
					<p>
					...
					<div>
						<form action="Purchase" method="post">
							...
							<input type="hidden" value="5" name="ProductKeyId"> <input
