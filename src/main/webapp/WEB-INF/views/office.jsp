<%@page import="java.util.List" %>
    <%@page import="project.dao.FactoryProvider" %>
        <%@page import="project.dao.OfficeFetchDao" %>
            <%@page import="project.beans.Office" %>
                            ...
                            <%@taglib prefix="spring" uri="http://www.springframework.org/tags" %>
                                <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                                    ...
                                    <head>
                                        ...
                                        <link href='https://fonts.googleapis.com/css?family=Open+Sans:300,400,700,300'
                                        ...
                                        <% String nameofuser=(String) session.getAttribute("username"); %>
                                            <%-- <div>
                                                <nav class="topbar">
                                                    ...
                                                    <button class="btn">
                                                        <% if (session.getAttribute("username")==null) { out.print("Log
                                                            In"); } else { out.print(session.getAttribute("username"));
                                                            } %>
                                                    </button>
                                                </nav>
                                                </div> --%>
                                                ...
                                                <header id="fh5co-header-section" class="sticky-banner">
                                                    <div class="container">
                                                        <div class="nav-header">
                                                            <a href="#"
                                                                class="js-fh5co-nav-toggle fh5co-nav-toggle dark"><i></i></a>
                                                            <h1 id="fh5co-logo">
                                                                <a href="index.jsp"><i
                                                                        class="icon-home"></i>Eternal<span>Empire</span></a>
                                                            </h1>
                                                            <!-- START #fh5co-menu-wrap -->
                                                            <nav id="fh5co-menu-wrap" role="navigation">
                                                                <ul class="sf-menu" id="fh5co-primary-menu">
                                                                    <li class="active"><a href="index.jsp">Home</a></li>
                                                                    <li><a href="properties.jsp"
                                                                            class="fh5co-sub-ddown">Properties</a>
                                                                        <ul class="fh5co-sub-menu">
                                                                            <li><a href="hospital">Hospital</a></li>
                                                                            <li><a href="resi">Residential Building</a>
                                                                            </li>
                                                                    ...
                                                                    <% int id=-1; String name="Login" ; String
                                                                        link="/project/login" ;
                                                ...
                                                <div class="house" style="margin-top: 25px;">
                                                    <center>
                                                        <h1 style="border-bottom: 2px dotted black;">-: Exotic
                                                            collections of Offices :-
                                                        </h1>
                                                    </center>
                                                </div>
                                                ...
                                                <c:forEach var="rb" items="${obj}">
                                                    ...
                                                    <div class="gallary" style="margin-bottom: 50px">
                                                        <div class="section">
                                                            <div class="img">
                                                                <img src="images/house/1.jpeg" alt="" srcset="">
                                                            </div>
                                                            <div class="description">
                                                                ...
                                                                <p>Owner Phone Number : <span>
                                                                        ${rb.getOwner().getPhoneNo()}
                                                                    </span></p>
                                                                <br>
                                                                <p>Number Of Waiting Rooms : <span>
                                                                        ${rb.getWaitingRooms() }
                                                                    </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Number
                                                                    Of
                                                                    Confrence Rooms :
                                                                    <span>
                                                                        ${rb.getConferenceRooms()}
                                                                    </span>
                                                                </p>
                                                                <br>
                                                                <p>City : <span
                                                                        style="margin-right: 280px;">${rb.getName}</span>Price
                                                                    : <span>${rb.getPrice()}</span></p>
                                                                <br>
                                                                <p>Description :- <span>
                                                                        ${rb.getDescription()}
                                                                    </span>
                                                                ...
                                                                <div>
                                                                    <form action="Purchase" method="post">
                                                                        <input type="hidden" value="${rb.getId()}"
                                                                            name="HouseId">
                                                                        <input type="hidden" value="4"
                                                                            name="ProductKeyId">
                                                                        <%-- <input type="hidden" value="custID"
                                                                            name="${ session.getAttribute("customerID") }"> --%>
                                                ...
                                                <footer class="footer-distributed">
                                                    ...
                                                    <div class="footer-left">
                                                        ...
                                                        <p class="footer-company-name">© 2003 Eternal Empire Pvt. Ltd.
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="footer-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p><a
                                                                    href="mailto:support@eduonix.com">support@ironman.com</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="footer-right">
                                                        <p class="footer-company-about">
                                                            ...
                                                            We offer wide and the exotic collection of the real estate
                                                            buildings and do global Transcations too
                                                        </p>
