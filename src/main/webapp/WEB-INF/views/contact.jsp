			...
			<header id="fh5co-header-section" class="sticky-banner">
				<div class="container">
					<div class="nav-header">
						...
						<h1 id="fh5co-logo">
							<a href="backtoindex"><i class="icon-home"></i>Home<span>state</span></a>
						</h1>
						<!-- START #fh5co-menu-wrap -->
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								<li><a href="index.html">Home</a></li>
								<li><a href="properties.html" class="fh5co-sub-ddown">Properties</a>
								...
								<div class="row">
									<div
										...
										<div class="slider-text-inner">
											...
											<p class="fh5co-lead">
												Designed with <i class="icon-heart3"></i> by the fine folks
												at <a href="http://freehtml5.co" target="_blank">FreeHTML5.co</a>
											</p>
										</div>
									</div>
								</div>
				...
				<div class="container">
					<div class="row">
						<div
							...
							<p>Can approach us anytime for all types of queries,bookings
								and any other deals.We will be more tham happy to serve you at
					...
					<div class="container">
						<div class="row row-bottom-padded-md">
							<div class="col-md-3">
								...
								<p>The only website where you can find the best holiday trip
									deals in afordable prices and can enjoy your trip to the
									fullest.</p>
							</div>
